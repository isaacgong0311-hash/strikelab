...
const Link001 = ({
  ...
  return (
    <a
      href={href}
      target="_blank"
      // Local change to the vendored registry file: upstream ships
      // target="_blank" with no rel, which leaves the opened page a live
      // window.opener handle back into StrikeLab (reverse tabnabbing).
