...
Three tracks, 23 lessons, each ending with a coding exercise — students fill in missing functions in a real pricing engine, run unit tests in-browser, and see live charts update.

**Investing Fundamentals** (Beginner, 9 lessons) — stocks, markets, financial statements, valuation, risk, portfolio building, bonds, retirement accounts, and common investing mistakes.

**Options Pricing** (Intermediate, 11 lessons):
...
| 11 | Rho: Interest Rate Sensitivity | The fifth Greek — why it matters for long-dated options |

**Quant Investing** (Advanced, 3 lessons) — CAPM and beta, backtesting, and portfolio optimization.
...
|---------|-------------|
| **Lesson track** | 23 structured lessons across three tracks, each ending with a Pyodide-powered coding exercise that runs directly in the browser — no install. |
